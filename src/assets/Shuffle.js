const Shuffle = (props) => (
  <svg width={20} height={18} xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    />
    <path
      d="m19.5 3-5 2.887V.113L19.5 3Zm-9.337 2.917-.454-.209.454.209Zm-2.826 6.166-.455-.208.455.208ZM.5 14.5h2.292v1H.5v-1Zm6.382-2.625L9.71 5.708l.909.417-2.827 6.167-.909-.417ZM14.71 2.5H15v1h-.291v-1Zm-5 3.208a5.5 5.5 0 0 1 5-3.208v1a4.5 4.5 0 0 0-4.091 2.625l-.91-.417ZM2.792 14.5a4.5 4.5 0 0 0 4.09-2.625l.91.417a5.5 5.5 0 0 1-5 3.208v-1Z"
      fill="#696969"
    />
  </svg>
);
